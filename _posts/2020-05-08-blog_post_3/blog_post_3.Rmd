...
Very cool job using pmap() to create plots (this chunk and the following ones). I almost forgot how to use the ggplot(..2, ) to map through two lists and reading your code helps me pick it up. One suggestion is probably modifying a bit the theme and color.
